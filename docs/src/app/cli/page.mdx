...
<table>
  ...
  <tbody>
    <tr>
      <td><code>zero-native init [path] [--frontend &lt;native|next|vite|react|svelte|vue&gt;]</code> (default: native)</td>
      <td>Scaffold a new zero-native project with the specified frontend (<code>native</code> scaffolds a native-rendered markup app with no web frontend). Omit <code>path</code> to scaffold into the current directory.</td>
    </tr>
    <tr>
