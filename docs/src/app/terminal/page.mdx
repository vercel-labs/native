...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Windows</td>
      <td>Supported — ConPTY (<code>CreatePseudoConsole</code>) over an overlapped pipe pair; UTF-8 with VT sequences in both directions, which is the pseudoconsole's own pipe contract. Behavioral differences below.</td>
    </tr>
    <tr>
      <td>Null / headless</td>
