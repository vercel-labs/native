...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Explicit opt-in on macOS, Linux, and Windows builds the compiler's build matrix covers</td>
    </tr>
  </tbody>
</table>
