...
State washes follow the built-in controls' behavior. Markup components customize their token references and compose the appropriate control kinds; app components do not add a second per-state styling channel.
