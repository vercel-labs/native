...
export const rules = {
  ...
  NS1067: {
    ...
    fix: "Export a synchronous named function taking zero arguments or one `Uint8Array` and returning `Uint8Array`; throw exactly `{ kind: \"...\", message: \"...\" }`, and call only an operation name listed by the generated service contract. Names beginning `__nativeSdk` are reserved for generated transport lowering.",
