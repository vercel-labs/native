...
pub const Runtime = struct {
    ...
    pub const setWindowVisible = WindowViewMethods.setWindowVisible;
    pub const setWindowClickThrough = WindowViewMethods.setWindowClickThrough;
    pub const pointerPosition = WindowViewMethods.pointerPosition;
    pub const screenWorkArea = WindowViewMethods.screenWorkArea;
