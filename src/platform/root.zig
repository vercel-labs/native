...
pub const CapturedAudioChunk = types.CapturedAudioChunk;
...
pub const CaptureAccessSource = types.CaptureAccessSource;
pub const CaptureAccessAction = types.CaptureAccessAction;
pub const CaptureAccessStatus = types.CaptureAccessStatus;
pub const CaptureAccessEvent = types.CaptureAccessEvent;
