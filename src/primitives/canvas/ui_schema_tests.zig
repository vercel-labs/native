...
test "registry codes are stable: assigned at birth, never renumbered or renamed" {
    ...
    // the terminal leaf (69), the reusable code composite (70), and
    // the rich-textarea leaf (71).
    try testing.expectEqual(
        @as(u64, 0x0380776b4e7f396c),
    ...
    // source-height (102), and the rich-textarea styles binding styles (103).
    try testing.expectEqual(
