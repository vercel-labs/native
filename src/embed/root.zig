...
pub const MobileCredentialService = types.MobileCredentialService;
...
pub const native_sdk_app_set_credential_service = c_api.native_sdk_app_set_credential_service;
