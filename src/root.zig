...
pub const EffectExternalRequest = runtime.EffectExternalRequest;
pub const EffectExternalResult = runtime.EffectExternalResult;
pub const EffectExternalOutcome = runtime.EffectExternalOutcome;
pub const ExternalEffectAdapterOutcome = runtime.ExternalEffectAdapterOutcome;
pub const ExternalEffectIssueError = runtime.ExternalEffectIssueError;
pub const ExternalEffectCompletion = runtime.ExternalEffectCompletion;
pub const ExternalEffectCompletionError = runtime.ExternalEffectCompletionError;
pub const ExternalEffectAdapter = runtime.ExternalEffectAdapter;
pub const max_effect_external_request_bytes = runtime.max_effect_external_request_bytes;
pub const max_effect_external_result_bytes = runtime.max_effect_external_result_bytes;
