...
pub const keycombo = @import("keycombo");
...
pub const ShortcutId = platform.ShortcutId;
pub const KeyCombo = keycombo.KeyCombo;
pub const KeyCode = keycombo.KeyCode;
pub const KeyModifier = keycombo.Modifier;
