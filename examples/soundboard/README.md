...
- `src/header.zml` — brand, library tabs, search field, theme buttons.
...
- `src/model.zig` — library data, playback/search/queue/theme state, `update`.
...
Right/ctrl-click a track row for the native context menu; Copy Title pipes the title through `pbcopy`. The theme buttons switch between following the system appearance and forcing light or dark.
