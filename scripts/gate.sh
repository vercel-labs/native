...
registered_examples="canvas-preview capabilities command-app effects-probe gpu-components gpu-dashboard gpu-surface habits kanban native-panels native-shell next react svelte ui-inbox vue"
